		...
		var dataForarch = [];
			...
			while (data) {
						if (data[x][0].trim() == 'Box') {
							...
							if (data[8][1].trim()){
								controlaccess = "<controlaccess><controlnote><p>"+ context +"</p></controlnote><genreform><part>" + data[8][1].trim() + "</part></genreform>";
								if(data[9][1].trim()){
								...
								controlaccess = "<controlaccess><controlnote><p>"+ context +"</p></controlnote><geogname source='" + data[9][3].trim() + "' identifier='" + data[9][2].trim() + "'><part>" + data[9][1].trim() + "</part></geogname></controlaccess>"; 
							}
							/*seriesid = data[8][1];
							series = data[8][2];*/
